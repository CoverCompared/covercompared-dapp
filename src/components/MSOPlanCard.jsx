  ...
  return (
    <>
      <div
        ...
        className="bg-white dark:bg-featureCard-dark-bg cursor-pointer rounded-xl pb-6 md:col-span-6 lg:col-span-3 col-span-12  border-2 border-white hover:border-primary-gd-1  flex flex-col justify-between"
      >
        <div>
