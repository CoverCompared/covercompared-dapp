...
const SmartContractCard = ({ policy }) => {
      ...
      <div className="flex sm:justify-end items-center min-w-max">
        ...
        {/* {company_code === 'nexus' && (
              <button
                ...
                type="button"
                className="md:px-5 px-3 py-3 ml-2 bg-gradient-to-r from-login-button-bg to-login-button-bg disabled:from-gray-200 disabled:to-gray-200 hover:from-primary-gd-1 hover:to-primary-gd-2 text-black font-Montserrat font-semibold md:text-body-md text-body-sm rounded-xl "
              >
