    ...
    <>
      ...
      <div className="md:px-24">
        <div className="mt-10 grid grid-cols-1 gap-y-6 xl:gap-y-8 gap-x-6 xl:gap-x-4 md:grid-cols-12 lg:grid-cols-12 w-full">
          <div className="md:col-span-5 col-span-12 md:col-end-5 md:pb-14 pb-10 order-2 md:order-1">
            ...
            <div className="text-dark-blue-1 font-semibold font-Montserrat md:my-4 my-2 md:text-h6 text-body-md dark:text-white">
              Cross Border Policy Issuance
            </div>
            <div className="text-post-body-text font-Inter md:w-64 md:text-body-md text-body-sm md:leading-6 leading-5 dark:text-subtitle-dark-text">
          ...
          <div className="md:col-span-5 col-span-12 md:col-end-5 md:pb-14 pb-10 order-3 md:order-3">
            ...
            <div className="text-dark-blue-1 font-semibold font-Montserrat my-4 md:text-h6 text-body-md dark:text-white">
              Insurance Policy <br />
              Purchase & Discounts
            </div>
            <div className="text-post-body-text font-Inter max-w-62 md:text-body-md text-body-sm md:leading-6 leading-5 dark:text-subtitle-dark-text">
          ...
          <div className="col-span-12 md:col-span-7 md:col-start-6 md:col-end-12 md:pb-14 pb-10 order-4 md:order-4">
            <div className="h-12 w-12 bg-login-button-bg rounded-xl flex justify-center items-center p-2">
            ...
            <div className="text-post-body-text font-Inter md:text-body-md text-body-sm md:leading-6 leading-5 max-w-lg dark:text-subtitle-dark-text">
          ...
          <div className="md:pb-14 pb-10 md:col-span-5 col-span-12 order-6">
            <div className="h-12 w-12 bg-login-button-bg rounded-xl flex justify-center items-center p-2">
            ...
            <div className="text-post-body-text font-Inter md:text-body-md text-body-sm md:leading-6 leading-5 dark:text-subtitle-dark-text">
              Redeem your claim through the CVR token for your favorite cryptocurrencies.
            </div>
          </div>
          <div className="md:col-span-7 col-span-12 md:col-start-6 md:col-end-12 md:pb-14 pb-10 order-7">
            <div className="h-12 w-12 bg-login-button-bg rounded-xl flex justify-center items-center p-2">
              <img src={RewardIcon} alt="" className="w-10" />
            </div>
            <div className="text-dark-blue-1 font-semibold font-Montserrat my-4 md:text-h6 text-body-md max-w-xs dark:text-white">
              P2P Risk Assessment & <br />
              Governance Rewards
            </div>
            <div className="text-post-body-text font-Inter md:text-body-md text-body-sm md:leading-6 leading-5 max-w-md dark:text-subtitle-dark-text">
        ...
        <div className="md:pb-14 pb-10">
          ...
          <div className="text-post-body-text font-Inter max-w-2xl md:text-body-md text-body-sm md:leading-6 leading-5 dark:text-subtitle-dark-text">
