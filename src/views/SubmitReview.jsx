      ...
      <form className="md:pr-28 md:pl-6 md:mb-8 md:mt-6">
        ...
        <div className=" relative mt-6">
          ...
          <textarea
            ...
            className="mt-3 py-2 px-4 h-32 rounded-lg appearance-none w-full border-dark-blue focus:border-dark-blue border-2 bg-promo-input-bg text-black placeholder-contact-input-dark-grey text-base focus:outline-none focus:ring-0 focus:border-0 focus:ring-shadow-none font-Montserrat font-semibold text-body-sm shadow-lg"
            placeholder="Reviews"
          />
        </div>
